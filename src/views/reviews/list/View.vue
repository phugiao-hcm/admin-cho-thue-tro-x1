    ...
    <div class="flex-between">
      <div>
        <p class="body-small-regular neutral-500">
          Danh sách các khách sạn mà bạn đã đánh giá gần đây, bạn có thể xem lại chi tiết đánh giá
          của mình tại đây.
        </p>
      </div>
    ...
    <div class="custom-grid-review" style="margin-top: 24px">
      <div v-for="(item, index) in hotelList" :key="index">
        <el-card class="box-card-mini" shadow="never">
          ...
          <p v-if="!item.averageMark" class="body-small-regular neutral-500" style="margin: 16px 0">
            Chưa có đánh giá
          </p>
          <div v-else>
            <div class="flex" style="margin: 16px 0">
              ...
              <div style="flex: 2" class="w-100">
                <div class="w-100 custom-gird-progress-mini">
                  ...
                  <div class="w-100">
                    <Progress color="#667085" :percentage="setAverageMark(3)"> </Progress>
                  </div>
                  <div>
